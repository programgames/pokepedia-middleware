# Generated by Django 3.2.23 on 2024-09-04 15:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forms', models.ManyToManyField(blank=True, related_name='pokemonmoveavailability', to='middleware.PokemonMoveAvailability')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('child', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='child_form', to='middleware.pokemonmoveavailability')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parent_form', to='middleware.pokemonmoveavailability')),
                ('version_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pokemon_v2.versiongroup')),
            ],
            options={

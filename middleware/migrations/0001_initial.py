# Generated by Django 3.2.23 on 2024-09-04 12:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forms', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pokemonmoveavailability', to='middleware.pkmavailabilityform')),
                ('machine', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pokemonmoveavailability', to='pokemon_v2.move')),
